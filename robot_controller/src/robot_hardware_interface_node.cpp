...
void ROBOTHardwareInterface::read()
{
    ...
    {
        // Assuming joint_read.response.res[0] is for the left wheel and joint_read.response.res[1] is for the right wheel
        ...
        // Corrected log to match the indices
        ROS_INFO("left wheel Pos : %.2f, right wheel Pos : %.2f", joint_position_[0], joint_position_[1]);
    }
    else
    {
        joint_position_[0] = 0;
...
void ROBOTHardwareInterface::write(ros::Duration elapsed_time)
{
    ...
    // Assuming joint_velocity_command_[0] is for the left wheel and joint_velocity_command_[1] is for the right wheel
